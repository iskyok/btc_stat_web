...
import {getDashCompanies, getCompanies,getAllCounties} from '../../../reducers/actions/coin/companies';
import Search from "./search";
import {push} from 'react-router-redux';
import _ from "lodash";
class CoinCompaniesIndex extends Component {
  constructor(props) {
    super(props);
    this.state = {
      todayTrade: 0,
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    getDashCompanies: (params) => dispatch(getDashCompanies(params)),
...
export default connect(mapStateToProps, mapDispatchToProps)(CoinCompaniesIndex);
