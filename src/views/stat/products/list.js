...
export class ProductsIndex extends React.Component {
  ...
  render() {
    ...
    const columns = [
      ...
      {title: "总销售额",dataIndex: "trades_amount",sorter: true,render(value, record) {
        return <span>{record['product_sum_amount']}</span>
      }},
      {title: "销量",dataIndex: "sale_count",sorter: true,render(value, record) {
      ...
      {title: "上架时间",dataIndex: "created_at",sorter: true,render(value, record) {
